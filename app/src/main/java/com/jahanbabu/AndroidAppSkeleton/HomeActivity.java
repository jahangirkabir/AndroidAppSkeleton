...
import com.jahanbabu.AndroidAppSkeleton.Utils.CircleTransform;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userEmailTextView = (TextView) headerView.findViewById(R.id.userEmailTextView);
        ...
        Picasso.with(mContext).load(uImage).transform(new CircleTransform()).into(profileImageView);
    }
